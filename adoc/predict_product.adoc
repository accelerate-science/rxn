...
This guide is a short tutorial to quickly learn how to use RXN for Chemistry predict forward reactions when starting with a set of known reagents.
////
...
========
SMILES string for use in product prediction. There are four molecules and one potassium ion in this string:
...
NOTE: Specific guidance and documentation for each of the machine learning models listed will be made available in Q4 2023.  
