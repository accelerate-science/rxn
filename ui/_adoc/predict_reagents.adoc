...
This guide is a tutorial to learn how to use RXN for Chemistry to predict the reagents needed to convert a given starting material to a desired product.
////
...
[NOTE]
====
* Number of steps in this tutorial: *23*
...
========
For the purposes of this tutorial you may use the following SMILES string for the reagent:
...
========
For the purposes of this tutorial you may use the following SMILES string for the product:
...
NOTE: The most recent AI model is selected in the dropdown list by default, but you may try others as desired.  
...
[%collapsible]
====
NOTE: Predicted reagents are outlined in green.

TIP: Use the controls to zoom in and out of the image.
...
* Executed a reagents prediction 
* Viewed the results in a Project
* Viewed the details of the predicted reagent reactions
* Viewed the TreeMAP, fingerprint, and attention heat map of the predicted reagent reactions
==== 
